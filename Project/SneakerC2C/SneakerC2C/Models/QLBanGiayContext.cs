...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=QLBanGiay;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DonHang>(entity =>
            {
                entity.HasIndex(e => e.MaDonHang)
                    .HasName("UQ__DonHang__129584ACCFBD5E4F")
                    .IsUnique();
            ...
            modelBuilder.Entity<GianHang>(entity =>
            {
                entity.HasIndex(e => e.MaGianHang)
                    .HasName("UQ__GianHang__1772B23026AF22FA")
                    .IsUnique();
            ...
            modelBuilder.Entity<GoiQuangCao>(entity =>
            {
                entity.HasIndex(e => e.MaGoiQuangCao)
                    .HasName("UQ__GoiQuang__7CE51DE396F65BCC")
                    .IsUnique();
            ...
            modelBuilder.Entity<HangSanPham>(entity =>
            {
                entity.HasIndex(e => e.MaHang)
                    .HasName("UQ__HangSanP__19C0DB1C2B759DAD")
                    .IsUnique();
            ...
            modelBuilder.Entity<LoaiNguoiDung>(entity =>
            {
                entity.HasIndex(e => e.MaLoaiNguoiDung)
                    .HasName("UQ__LoaiNguo__8D19731816EBC2B9")
                    .IsUnique();
            ...
            modelBuilder.Entity<QuangCao>(entity =>
            {
                entity.HasIndex(e => e.MaQuangCao)
                    .HasName("UQ__QuangCao__9353FEC3C4A029D2")
                    .IsUnique();
            ...
            modelBuilder.Entity<SanPham>(entity =>
            {
                entity.HasIndex(e => e.MaSanPham)
                    .HasName("UQ__SanPham__FAC7442CC47E845D")
                    .IsUnique();
            ...
            modelBuilder.Entity<TaiKhoan>(entity =>
            {
                entity.HasIndex(e => e.Cmnd)
                    .HasName("UQ__TaiKhoan__F67C8D0B1B8B2017")
                    .IsUnique();

                entity.HasIndex(e => e.Email)
                    .HasName("UQ__TaiKhoan__A9D10534873E3E96")
                    .IsUnique();

                entity.HasIndex(e => e.TenDangNhap)
                    .HasName("UQ__TaiKhoan__55F68FC067D23EBF")
                    .IsUnique();
            ...
            modelBuilder.Entity<TinhThanh>(entity =>
            {
                entity.HasIndex(e => e.MaTinhThanh)
                    .HasName("UQ__TinhThan__B8FF995F659151FC")
                    .IsUnique();
            ...
            modelBuilder.Entity<TrangQuangCao>(entity =>
            {
                entity.HasIndex(e => e.MaTrang)
                    .HasName("UQ__TrangQua__399828AE86C72513")
                    .IsUnique();
            ...
            modelBuilder.Entity<ViTriQuangcao>(entity =>
            {
                entity.HasIndex(e => e.MaViTri)
                    .HasName("UQ__ViTriQua__B08B247EFCE4B21A")
                    .IsUnique();
